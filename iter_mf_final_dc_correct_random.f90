...
!**** Derek S. Middlemiss, Cambridge, June 2013
...
INTEGER*4 :: time_array_1(3),time_array_2(3)
...
CALL itime(time_array_1)

IF (detail .eqv. .true.) THEN
  WRITE(*,*) "Sleeping for",(time_array_1(1)+time_array_1(2)+time_array_1(3))/10
END IF

CALL sleep((time_array_1(1)+time_array_1(2)+time_array_1(3))/10) 
CALL itime(time_array_2)
time_array_1=time_array_1*time_array_2(3)
CALL srand((time_array_1(1)+time_array_1(2)+time_array_1(3)))

IF (detail .eqv. .true.) THEN
  WRITE(*,*) "Random seed:",(time_array_1(1)+time_array_1(2)+time_array_1(3))
END IF

CALL itime(time_array_1)
i=rand(time_array_1(1)+time_array_1(2)+time_array_1(3))

IF (detail .eqv. .true.) THEN
  WRITE(*,*) "First ten random numbers:"
  DO i=1,10,1
    WRITE(*,*) rand(0)
  END DO
END IF
...
DO Tcount=1,Tstop,1
  ...
  WRITE(*,*) "Temperature step",Tcount,"of",Tstop,"-- Maximum SCF steps last temperature:",max_count
